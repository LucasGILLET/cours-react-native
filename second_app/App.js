...
export default function App() {
  ...
  const [fiveDaysData, setFiveDaysData] = React.useState([]);
  ...
  return (
    <View style={styles.container}>
      ...
      { isLoading ? 
      <View><Text style={styles.loading}>Data is loading...</Text></View> : 
      
      <View>
        <TouchableOpacity style={styles.button} onPress={reloadData}><Text style={styles.button.text}>Reload</Text></TouchableOpacity>
        <Today data={data}/>
        <FiveDays data={fiveDaysData.list} />
      </View>
      }
